...
const Footer = () => {
  ...
  return (
    <>
      <div className="relative mx-auto flex w-[90%] flex-col items-center gap-6 bg-[#0d0d0eb3] pb-6 pt-10 text-center lg:flex-row lg:items-start lg:justify-between lg:gap-10 lg:pt-20 lg:text-start xl:w-3/4">
